...
const achievements = [
  {
    ...
    description: 'Top 4% globally, 550+ problems solved across DP, graphs & system design',
    icon: <Trophy className="w-8 h-8 text-yellow-500/80" />,
    color: 'from-yellow-500/10 to-orange-500/5'
  },
  {
    title: 'Codeforces Specialist',
    description: 'Competitive programming rank earned through consistent contest participation',
    icon: <Medal className="w-8 h-8 text-purple-500/80" />,
    color: 'from-purple-500/10 to-pink-500/5'
  },
  {
    title: 'IIT Bombay FOSSEE Fellow',
    description: 'Led a 5+ contributor team building an open-source Drupal 10 theme, adopted across IIT portals',
