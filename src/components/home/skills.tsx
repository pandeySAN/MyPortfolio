...
const skillsData = [
  {
    ...
    skills: ['Python', 'C++', 'Dart', 'JavaScript', 'TypeScript', 'SQL'],
  },
  {
    category: 'Backend & APIs',
    icon: <Server className="w-6 h-6 text-accent" />,
    skills: ['Django REST Framework', 'FastAPI', 'REST APIs', 'Microservices', 'OOP', 'System Design'],
  },
  {
    category: 'Frameworks',
    icon: <BrainCircuit className="w-6 h-6 text-accent" />,
    skills: ['Flutter', 'Next.js', 'React', 'Express.js'],
  },
  {
    category: 'Data',
    icon: <Database className="w-6 h-6 text-accent" />,
    skills: ['PostgreSQL', 'Redis', 'MongoDB', 'Celery'],
  },
  {
    category: 'Cloud & DevOps',
    icon: <Cloud className="w-6 h-6 text-accent" />,
    skills: ['AWS (EC2, ECS, Lambda, S3, CloudWatch)', 'Docker', 'Kubernetes', 'Linux', 'Git', 'GitHub Actions/CI-CD', 'Nginx'],
  },
  {
    category: 'Practices',
    icon: <Code2 className="w-6 h-6 text-accent" />,
    skills: ['Agile/Scrum', 'Code Review', 'Unit/Integration Testing', 'Incident Response'],
  },
];
